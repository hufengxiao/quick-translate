...
```
Agent(
  prompt="Read C:/Users/hufen/projects/quick-translate/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/hufen/projects/quick-translate/.hermes/gsd-core/templates/SECURITY.md`
