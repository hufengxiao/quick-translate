...
- **Global scope**: `C:/Users/hufen/projects/quick-translate/.hermes/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/hufen/projects/quick-translate/.hermes/notes/`)
...
2. Glob `C:/Users/hufen/projects/quick-translate/.hermes/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/hufen/projects/quick-translate/.hermes/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/hufen/projects/quick-translate/.hermes/notes/` — works in any directory
