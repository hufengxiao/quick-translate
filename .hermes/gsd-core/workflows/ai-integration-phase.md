...
<required_reading>
@C:/Users/hufen/projects/quick-translate/.hermes/gsd-core/references/ai-frameworks.md
...
```markdown
Read C:/Users/hufen/projects/quick-translate/.hermes/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/hufen/projects/quick-translate/.hermes/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/hufen/projects/quick-translate/.hermes/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/hufen/projects/quick-translate/.hermes/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/hufen/projects/quick-translate/.hermes/agents/gsd-eval-planner.md for instructions.
