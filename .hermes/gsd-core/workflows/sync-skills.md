...
INSTALL_JS_GLOBAL="C:/Users/hufen/projects/quick-translate/.hermes/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/hufen/projects/quick-translate/.hermes/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
